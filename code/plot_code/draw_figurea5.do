	...
	import excel "figurea5.xlsx", sheet("Sheet1") firstrow clear
...
twoway  (rarea ub lb time if type==2 & var=="expense" ,color("112 160 255 %60") lc(blue%60))  ///
 ...
 (scatter coef time if time==3 & var=="expense",color(black%60)  yline(0) xtitle("Forecast Error (Rain Level)")  ytitle("Medical Expenses") xlabel(0 "≤-3" 1 "-2" 2 "-1" 3 "0" 4 "1" 5 "2" 6 "≥3", tposition(inside)) ylabel(-1(1)3, tposition(inside))) 
...
twoway  (rarea ub lb time if type==2 & var=="visit" ,color("112 160 255 %60") lc(blue%60))  ///
 ...
 (scatter coef time if time==3 & var=="visit",color(black%60)  yline(0) xtitle("Forecast Error (Rain Level)")  ytitle("Healthcare visit") xlabel(0 "≤-3" 1 "-2" 2 "-1" 3 "0" 4 "1" 5 "2" 6 "≥3", tposition(inside)) ylabe(-0.3(0.3)0.9, tposition(inside)) ) 
