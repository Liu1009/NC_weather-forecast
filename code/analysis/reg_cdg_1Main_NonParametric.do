...
use treated_hosp_weathter_full_cdg0, clear
	...
	summarize Expense_total_pop visit_pop dif_TempHigh r_TempHigh r_WindAvg r_RainVol r_HumiAvg  r_PM25 [aweight=pop_cyg]
...
////////////////////////////////////////////////////////////////////////////////////////	
	...
	*- Reg: 
	...
	cap erase "$tables/AppendixTable/AppendixTableA2.xls"
	cap erase "$tables/AppendixTable/AppendixTableA2.txt"
	...
	foreach prefix in "l_" {
		foreach suffix in   `w'_pop  {
			foreach sample in "1" { 
				...
				outreg2 using "$tables/AppendixTable/AppendixTableA2.xls" ,append dec(3) keep(CUM_dif_TempHigh_CB* L*_dif_TempHigh_CB*)
